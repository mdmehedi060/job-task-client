                ...
                <div className="navbar-end">
                    <div className="flex items-center justify-center">
                        ...
                        <label className="swap swap-rotate">
                            ...
                            <input className="opacity-0" type="checkbox" onChange={toggle} checked={theme === "valentine" ? false : true} />
                                ...
                                user && (<>
                                    ...
                                    <div className="dropdown dropdown-end">
                                        ...
                                        <ul tabIndex={0} className="dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box ">
                                            <li className="block p-1 font-sans text-lg font-bold  text-inherit ">
                                                <NavLink
                                                    to="/dashboard"
                                                    className={({ isActive, isPending }) =>
                                                        isPending ? "pending" : isActive ? "text-[#000000]  underline" : ""
